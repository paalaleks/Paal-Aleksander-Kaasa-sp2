...
})({"5zaVR":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _headerScss = require("../components/header.scss");
var _featuredJs = require("../components/featured.js");
var _featuredJsDefault = parcelHelpers.interopDefault(_featuredJs);
...
var _indexSearchJs = require("../js/search/indexSearch.js");
var _indexSearchJsDefault = parcelHelpers.interopDefault(_indexSearchJs);
//////////////////////
// search functions //
//////////////////////
const index = ()=>{
    document.getElementById("nav").innerHTML = _navJsDefault.default(), _indexSearchJsDefault.default(), (()=>{
        document.getElementById("cart").innerHTML = _cartIconJsDefault.default();
    })();
    document.getElementById("header").innerHTML = _headerJsDefault.default();
    document.getElementById("featured").innerHTML = _featuredJsDefault.default();
    document.getElementById("footer").innerHTML = _footerJsDefault.default();
};
// init index
index();

},{"../styles/global.scss":"f11eJ","../components/nav.js":"kefMG","../components/cartIcon.js":"jtS7N","../components/nav.scss":"X132T","../components/header.js":"aorvA","../components/header.scss":"cRpKT","../components/featured.js":"hsMPY","../components/footer.js":"bjsug","../components/footer.scss":"8laDV","../js/search/indexSearch.js":"5P14C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f11eJ":[function() {},{}],"kefMG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"jtS7N":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function UpdateCart() {
    const update = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"X132T":[function() {},{}],"aorvA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _apiJs = require("../js/api/api.js");
const header = document.getElementById("header");
const Header = async ()=>{
    const heroUrl = _apiJs.baseUrl + "/home";
    try {
        const response = await fetch(heroUrl);
        const json = await response.json();
        header.innerHTML = "";
        header.innerHTML = `
    <img class="hero-img" src="${_apiJs.baseUrl}${json.hero_banner.url}" alt="${json.hero_banner_alt_text}" />
...
},{"../js/api/api.js":"lc5OC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lc5OC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cRpKT":[function() {},{}],"hsMPY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _apiJs = require("../js/api/api.js");
const productsList = document.getElementById("featured");
const Featured = async ()=>{
    const productsUrl = _apiJs.baseUrl + "/products";
    try {
        const response = await fetch(productsUrl);
        const json = await response.json();
        productsList.innerHTML = "";
        json.forEach((product)=>{
            if (product.featured == true) productsList.innerHTML += `
          <a href="./productDetails.html?id=${product.id}">
            <div class="products-content">
              <div class="products-img" style="background-image: url(${_apiJs.baseUrl}${product.image.formats.small.url});"></div>
...
},{"../js/api/api.js":"lc5OC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bjsug":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const Footer = ()=>{
    const footer = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8laDV":[function() {},{}],"5P14C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function Search() {
    ...
    search.addEventListener("keyup", async (e)=>{
        ...
        if (!searchString) {
            _headerJsDefault.default();
            _featuredJsDefault.default();
        ...
        if (searchString.length > 1) {
            ...
            const filteredProducts = json.filter((product)=>{
                return product.title.trim().toLowerCase().includes(searchString) || product.description.trim().toLowerCase().includes(searchString);
            });
            // Empty message
        ...
        function displayProducts(products) {
          ...
          <a href="./productDetails.html?id=${product.id}">
            <div class="products-content">
              <div class="products-img" style="background-image: url(${_apiJs.baseUrl}${product.image.formats.medium.url});"></div>
              <p>${product.title} <span class="price-tag">$${product.price}</span></p>
            </div>
          </a>
          `;
...
},{"../api/api.js":"lc5OC","../../components/header.js":"aorvA","../../components/featured.js":"hsMPY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5zaVR","dpPH2"], "dpPH2", "parcelRequire8d29")
